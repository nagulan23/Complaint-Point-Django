# Generated by Django 3.1.2 on 2020-11-16 09:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.CharField(db_column='Bio', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('important_dates', models.CharField(db_column='Important_dates', max_length=15)),
            ],
            options={
